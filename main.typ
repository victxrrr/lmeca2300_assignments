...
// #show: slides.with(
//   title: "Accélération du code de calcul Watlab", // Required
//   subtitle: "Recherches bibliographiques et perspectives", // Optional
//   date: datetime.today().display(
//     "[day]/[month]/[year]"
//   ),
//   authors: ("Victor Lepère"),

//   // Optional Styling
//   ratio: 16/9,
//   layout: "medium",
//   title-color: rgb("00214e"),
//   footer: true,
//   count: false,
//   toc: false)
